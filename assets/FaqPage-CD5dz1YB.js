import{j as e,H as r,l as c}from"./index-DqUIsqJl.js";import{T as t}from"./TitleSEO-DkJVkWsi.js";import{s,P as l}from"./ParseTextToJSX-DxLan_zj.js";import{B as d}from"./BotonNav-Cb7dNNa-.js";import{S as p}from"./ScrollReveal-BBfqL0zt.js";const m=a=>({"@context":"https://schema.org","@type":"FAQPage",mainEntity:a.map(o=>({"@type":"Question",name:o.question,acceptedAnswer:{"@type":"Answer",text:o.answer}}))}),n=[{id:1,question:"¿Qué precio tienen sus servicios?",answer:`Nuestros servicios están organizados en programas y proyectos con precio fijo según el alcance. Contamos con:
...
El éxito del proyecto depende del trabajo conjunto entre el cliente y el despacho.`}],u=m(n),v=()=>e.jsxs("main",{children:[e.jsx(t,{title:"Foodie Guru | FAQ",description:"Encuentra respuestas claras y rápidas a las dudas más comunes sobre el servicio de Foodie Guru.",canonical:"https://foodieguru.mx/faq"}),e.jsx(r,{children:e.jsx("script",{type:"application/ld+json",children:JSON.stringify(u)})}),e.jsxs("section",{className:s.sectionContainer,children:[e.jsxs("header",{className:s.sectionTitulo,children:[e.jsx("h1",{className:"formula-bold",children:"PREGUNTAS FRECUENTES"}),e.jsx(p,{mode:"clone",from:"left",distance:30,duration:1,threshold:.1,children:e.jsx("img",{src:c,alt:"Logotipo de Foodie Guru"})})]}),e.jsx("div",{className:s.sectionContenido,children:n.map(({id:a,question:o,answer:i})=>e.jsxs("div",{className:s.faqItem,children:[e.jsx("h3",{className:"formula-bold",children:`${a}. ${o}`}),e.jsx("div",{className:"alliance-text",children:l(i,a)}),e.jsx("hr",{})]},a))}),e.jsx(d,{dataCta:"faq-btn",children:"Solicitar Cita"}),e.jsx("hr",{})]})]});export{v as default};
