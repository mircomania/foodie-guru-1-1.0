import{j as e,H as r,l as c}from"./index-x_f9mlnX.js";import{T as t}from"./TitleSEO-DeuYsmHc.js";import{s,P as d}from"./ParseTextToJSX-DE41-pmF.js";import{B as l}from"./BotonNav-CfP-71A3.js";const p=a=>({"@context":"https://schema.org","@type":"FAQPage",mainEntity:a.map(o=>({"@type":"Question",name:o.question,acceptedAnswer:{"@type":"Answer",text:o.answer}}))}),n=[{id:1,question:"¿Qué precio tienen sus servicios?",answer:`Nuestros servicios están organizados en programas y proyectos con precio fijo según el alcance. Contamos con:
...
El éxito del proyecto depende del trabajo conjunto entre el cliente y el despacho.`}],m=p(n),b=()=>e.jsxs("main",{children:[e.jsx(t,{title:"Foodie Guru | FAQ",description:"Encuentra respuestas claras y rápidas a las dudas más comunes sobre el servicio de Foodie Guru.",canonical:"https://foodieguru.mx/faq"}),e.jsx(r,{children:e.jsx("script",{type:"application/ld+json",children:JSON.stringify(m)})}),e.jsxs("section",{className:s.sectionContainer,children:[e.jsxs("header",{className:s.sectionTitulo,children:[e.jsx("h1",{className:"formula-bold",children:"PREGUNTAS FRECUENTES"}),e.jsx("img",{src:c,alt:"Logotipo de Foodie Guru"})]}),e.jsx("div",{className:s.sectionContenido,children:n.map(({id:a,question:o,answer:i})=>e.jsxs("div",{className:s.faqItem,children:[e.jsx("h3",{className:"formula-bold",children:`${a}. ${o}`}),e.jsx("div",{className:"alliance-text",children:d(i,a)}),e.jsx("hr",{})]},a))}),e.jsx(l,{dataCta:"faq-btn",children:"Solicitar Cita"}),e.jsx("hr",{})]})]});export{b as default};
