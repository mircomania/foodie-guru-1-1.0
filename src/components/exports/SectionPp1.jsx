...
const POLITICAS_LINK = (
    <NavLink to="/" title="ir a foodieguru.mx" data-link="politicas-home-link">
        foodie guru
    </NavLink>
);
    ...
    return (
        <section className={styles.sectionContainer}>
            <header className={styles.sectionTitulo}>
                ...
                <h2 className="alliance-text">foodieguru.mx</h2>
            </header>

            <div className={`${styles.sectionContenido} alliance-text`}>
                <p>
